...
var khaledQuote = "MAJOR KEY ALERT!";

document.getElementById("khaled").addEventListener('click', sayAgainQuote);

function sayAgainQuote(){
  document.getElementById("wedabest").innerHTML = khaledQuote;
}
...
function sayQuotes(){
var randomX = Math.floor(Math.random()*quotes.length);
